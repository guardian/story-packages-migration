...
module.exports = function (articles) {
	...
	articles.forEach(article => {
		if (article) {
			...
			modDate[article.MODIFIED_ON] = true;
			modBy[article.MODIFIED_BY] = true;
		}
	});

	console.log('Found modified on ', Object.keys(modDate));
	console.log('Found modified by ', Object.keys(modBy));
